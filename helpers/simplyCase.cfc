...
component accessors="true" {
  ...
  */
  ...
  /**
  * @hint Appends a single product to the existing product array
  */
  public any function addProduct(required numeric product) {
  ...
  */
  public any function product(required numeric product) {
  ...
  */
  ...
  /**
  * @hint Appends a single condition to the existing condition array
  */
  public any function addCondition(required numeric condition) {
  ...
  */
  public any function condition(required numeric condition) {
    return addCondition(arguments.condition);
  }

  /**
  * @hint Appends a single "information" to the existing information array
  */
  public any function addInformation(required numeric information) {
  ...
  */
  public any function addInfo(required numeric information) {
  ...
  */
  public any function information(required numeric information) {
    return addInformation(arguments.information);
  }
